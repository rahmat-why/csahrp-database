...
namespace PRG2_20232_P6_100
{
    public partial class MDIParent1 : Form
    {
        ...
        {
            FormListSupplier formList = new FormListSupplier();
        ...
        {
            FormUpdateSupplier formUpdate = new FormUpdateSupplier();
            formUpdate.MdiParent = this;
        ...
        {
            FormDeleteSupplier formDelete = new FormDeleteSupplier();
            formDelete.MdiParent = this;
